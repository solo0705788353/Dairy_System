...
<html lang="en">
  <head>
    ...
    <script>
      <!--
        var ScrollMsg= "Rongo Dairy System "
          ...
          <ul class="nav nav-justified">
            ...
            <div class="well bs-component">
              <form class="form-horizontal" action="#" name="form">
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">Damages  :</label>
                  <div class="col-sm-4">
                    <?php echo $gsis; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Savings  :</label>
                  <div class="col-sm-4">
                    <?php echo $love; ?>.00
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">Damages</label>
                  <div class="col-sm-8">
