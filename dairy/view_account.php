                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $phil; ?>">NSSF</option>
                      <option value="<?php echo $bir; ?>">NHIF</option>
                      <option value="<?php echo $gsis; ?>">Damages</option>
                      <option value="<?php echo $love; ?>">Savings</option>
