...
<?php
  $data = "SELECT * from overtime";
  $query  = mysqli_query($connection, $data);
  while($row=mysqli_fetch_array($query))
  {
    @$rate           = $row['rate'];
  }
  $data1 = "SELECT * from salary";
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="home_salary.php">Income</a></li>
                ...
                <div class="table-responsive">
                  <form method="post" action="" >
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        <?php
                          $data2 = "SELECT * from overtime";
                          $query  = mysqli_query($connection, $data2);
                          while($row=mysqli_fetch_array($query))
                          {
                            $rate   = $row['rate'];
                          }

                          $data3 = "SELECT * from salary";
                          $query  = mysqli_query($connection, $data3);
                          while($row=mysqli_fetch_array($query))
                          {
                            $salary_rate   = $row['salary_rate'];
                          }
                          $data4 = "SELECT * from employee"; 
                          $query  = mysqli_query($connection, $data4);
                          while($row=mysqli_fetch_array($query))
                          {
                            $lname           = $row['lname'];
                            $fname           = $row['fname'];
