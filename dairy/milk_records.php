      ...
      <div class="masthead">
        ...
        <nav>
          ...
          $user_type = $_SESSION['user_type'];
            ...
            <li class='active'><a href='milk_records.php'>Milk Records</a></li>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <thead>
                        <tr class="info">
                          ...
                          <th><p align="center">Cow Name</p></th>
                          <th><p align="center">Date</p></th>
                          <th><p align="center">Time</p></th>
                          <th><p align="center">Period</p></th>
                          <th><p align="center">Milked By</p></th>
                          <th><p align="center">Amount (Ltrs)</p></th>
                      ...
                      <tbody>
                        <?php
                          ...
                          $data = "select * from tbl_milk ORDER BY milk_id asc";
                        ...
                        <tr>
                          <td align="center"><a href="#" title="Update">ML<?php echo $row['milk_id']; ?>QX</a></td>
                          <td align="center"><a href="#" title="Update"><?php echo $row['cow_name'] ?></a></td>
                          <td align="center"><a href="#" title="Update"><?php echo $row['milk_date'] ?></a></td>
                          <td align="center"><a href="#" title="Update"><?php echo $row['milk_time'] ?></a></td>
                          ...
                          <td align="center"><a href="#" title="Update"><?php echo $row['milk_amount'] ?></a></td>
                          <td>
                          <?php
                          $user_type = $_SESSION['user_type'];
                          if($user_type == 'admin'){
                            echo "<a class='btn btn-primary' href='#'>View</a>
                            <a class='btn btn-danger' href='deletemilk.php?milk_id=$id'>Delete</a>";
                          } else {
                            echo "Must Be admin!";
                          }
                          ?>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header" style="padding:20px 50px;">
              ...
              <h3 align="center"><b>Add Milk Record</b></h3>
            </div>
            <div class="modal-body" style="padding:40px 50px;">

              <form class="form-horizontal" action="#" name="form" method="post">
                <div class="form-group">
                  <label class="col-sm-4 control-label">Cow Name:</label>
                  <div class="col-sm-8">
                    <select name="cow_name" class="form-control" placeholder="Cow Name" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="milk_date" class="form-control" value="<?php echo date("Y-m-d");?>" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Time:</label>
                  <div class="col-sm-8">
                    <input type="text" name="milk_time" class="form-control" value="<?php echo date("h:i:s");?>"  required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Period:</label>
                  <div class="col-sm-8">
                    <select name="period" class="form-control" placeholder="Cow Name" required>
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">Milked by: </label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">Amount (Ltrs):</label>
                  <div class="col-sm-8">
                    <input type="number" step="any" name="amount" class="form-control" required="required">
                  </div>
                </div>
                <div class="form-group">
