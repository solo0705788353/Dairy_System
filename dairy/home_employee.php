          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
                ...
                <a class="btn btn-warning" href="home_deductions.php">Deductions</a>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="division" class="form-control" placeholder="Marital status" required/>
                  </div>
                </div>
